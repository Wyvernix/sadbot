...
//				System.out.println(mods.contains(sender));
...
//			if (message.startsWith("command") && (mods.contains(sender) || sender.equals("shady1765"))) {
...
//			this.sendMessage(channel, sender + " is derp. [command/user]");
//			System.out.println(message);
//			return;
//			}
//			//TODO end
